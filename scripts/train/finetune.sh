...
# NUM_OUTPUT=$(python setup_data.py data-dir=/data/ad6813/pipe-data/Bluebox/raw_data/dump data-info=/data/ad6813/caffe/data_info/$BASE_NAME to-dir=/data/ad6813/caffe/data/$BASE_NAME bad-min=$BAD_MIN)
