...
DATA=$CAFFE/data/scrape_zone_peel
DATA_INFO=$CAFFE/data_info/scrape_zone_peel
...
GLOG_logtostderr=1 $TOOLS/convert_imageset.bin \
    $DATA/train/ \
    $DATA_INFO/train.txt \
    scrape_zone_peel_fine_train_leveldb 1

GLOG_logtostderr=1 $TOOLS/convert_imageset.bin \
    $DATA/val/ \
    $DATA_INFO/val.txt \
    scrape_zone_peel_fine_val_leveldb 1

GLOG_logtostderr=1 $TOOLS/convert_imageset.bin \
    $DATA/test/ \
    $DATA_INFO/test.txt \
    scrape_zone_peel_fine_test_leveldb 1
